        ...
        if isinstance(elem, DB.FamilyInstance):
            try:
                ...
                if isinstance(location, DB.LocationPoint):
                    ...
                    # Define o normal do plano com base na direção (relativa à vista atual)
                    if direction == 'Horizontal':
                        normal = active_view.UpDirection  # Horizontal: flip left-right (normal ao eixo Y da vista)
                    else:
                        normal = active_view.RightDirection  # Vertical: flip up-down (normal ao eixo X da vista)
